  ...
  return (
    ...
    >
      ...
      <SidebarFooter className="px-2 pb-4">
        ...
        {/* Social Icons */}
        <div className="flex items-center justify-start gap-4 px-3 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:gap-3 group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:items-center">
          <a
            href="https://t.me/+RJV2NKAo85Y1Yjhk"
            target="_blank"
          ...
          <a
            href="https://x.com/thecanvassing"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sidebar-foreground/50 hover:text-sidebar-foreground transition-colors"
